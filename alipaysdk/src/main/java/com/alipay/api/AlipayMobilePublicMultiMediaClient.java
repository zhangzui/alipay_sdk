...
public class AlipayMobilePublicMultiMediaClient implements AlipayClient {
    ...
    /** 
     * @see AlipayClient#execute(com.alipay.api.AlipayRequest)
     */
    ...
    /** 
     * @see AlipayClient#execute(com.alipay.api.AlipayRequest, String)
     */
    ...
    /** 
     * @see AlipayClient#execute(com.alipay.api.AlipayRequest, String, String, String)
     */
